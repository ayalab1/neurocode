...
%brainRegions - CA1 fix extension on both  
    ...
    %probes - PFC (PL)
    session.animal.probeImplants{1, 2}.probe='A5x12-16-Buz-lin-5mm-100-200-160-177';
    session.animal.probeImplants{1, 2}.supplier='NeuroNexus';
    session.animal.probeImplants{1, 2}.nShanks=5;
    session.animal.probeImplants{1, 2}.nChannels=64;
    session.animal.probeImplants{1, 2}.shankSpacing=800;
    session.animal.probeImplants{1, 2}.layout='poly 2';
    session.animal.probeImplants{1, 2}.verticalSpacing='20';
    session.animal.probeImplants{1, 2}.descriptiveName='A5x12-16-Buz-lin-5mm-100-200-160-177 (64 ch, 5 shanks, poly 2 Non-uniform )';
