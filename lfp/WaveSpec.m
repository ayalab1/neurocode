...
% WaveSpec: bz_WaveSpec calculates the wavelet transform of a signal
%
% calculates the wavelet transform of a signal with nfreqs frequencies in the range frange
