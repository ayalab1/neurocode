...
FO.EegUpdateBoolean = false;
FO.stateAxisToggleModeBool = true;
...
if nargout == 0
    ...
    for Ch1=1:nChannels, for Ch2 = 1:nChannels
            ...
            if Ch1==Ch2
                if length(t)==1
                    imagesc([0 1/f(2)],f,20*log10(abs(y(:,:,Ch1,Ch2))+eps)');axis xy;
                else
                    imagesc(t,f,20*log10(abs(y(:,:,Ch1,Ch2))+eps)');axis xy;
                end
            else
                imagesc(t,f,(abs(y(:,:,Ch1,Ch2)))');axis xy;
            end
        end; end;
    xlabel('Time')
    ylabel('Frequency')
