...
for i = 1:2:length(varargin)
    ...
    switch(lower(varargin{i}))
        case 'binsize'
            binSize = varargin{i+1}; binSizeProvided = true;
        ...
        case 'bins'
            bins = varargin{i+1}; binsProvided = true;
            if ~isdmatrix(bins,'@2')
...
if binsProvided && binSizeProvided
...
if binsProvided && isempty(bins), return; end
...
nor = ones(1,size(weights,2)); for i=1:size(weights,2),nor(1,i)=norm(weights(:,i)); end
