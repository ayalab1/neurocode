...
if isempty(tracking) && exist([basepath,filesep,[basename,'.Tracking.behavior.mat']],'file')
...
v = sqrt(vx.^2+vy.^2);  
% v needs to be transformed to cm/s 
...
% need improvement
figure;
plot(behavior.time,behavior.linearized,'k','LineWidth',2);hold on;
