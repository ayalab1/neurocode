...
for j=1:nRepetitions
    ...
    for i=1:length(stimuli)
        ...
        if useArduino, writeDigitalPin(a, 'D12', 1); writeDigitalPin(a, 'D13', 0); end % send arduino signal 0 (empty screen)
        ...
        for k=1:nFlashesPerStimulus
            ...
            if useArduino, writeDigitalPin(a, 'D12', 1); writeDigitalPin(a, 'D13', 1); end % send arduino signal 0 (empty screen)
            data(currentLine,1)=datenum(datetime('now','Format','MM/dd/yy HH:mm:ss.SSSSSS'));
