...
basepath = 'N:\V1test\V1JeanBaptiste\V1JeanBaptiste_220706'
cd(basepath);
...
% while isempty(f)
%     disp([datestr(clock) ': LFP not yet available. Waiting...']);
%     pause(60*10); % pause for 10 minutes and check again
% end

% when LFP file is there, this means that .dat file is definitely finished. Clean it
...
kilosortFolder = KiloSortWrapper('SSD_path',SSD_path,'NT',1.5*1024);
...
%% Start denoising other sessions
% nDays = 43;
nDays = 35;
