function ops = KilosortConfiguration(varargin)
%K% edited 3/11/21
...
chanMapFile = checkFile('basepath',basepath,'filename','chanMap.mat');
...
ops.fbinary             = [datFile.folder filesep datFile.name]; % will be created for 'openEphys'
...
ops.chanMap             = [chanMapFile.folder filesep chanMapFile.name]; % make this file using createChannelMapFile.m
