...
% Perform Kalman filter on raw video tracker data to estimate animal trajectory.
%
% The goal is to obtain an approximate Bayesian MAP estimate to an animal's 
